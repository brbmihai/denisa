...
class Solace_Extra_Checkout extends Widget_Base {

	public function __construct( $data = array(), $args = null ) {
		parent::__construct( $data, $args );
		wp_register_style( "solace-extra-checkout", plugins_url( "assets/css/style.css", __FILE__ ), array(), SOLACE_EXTRA_VERSION );
	}	

	public function get_style_depends() {
		return array( "solace-extra-checkout" );
	}
	...
	public function get_title() {
		return esc_html__( 'Checkout', 'solace-extra' );
	}

	public function get_icon() {
		return 'eicon-checkout wlbi solace-extra';
	}

	public function get_categories() {
		return ['solace-extra-checkout'];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_general',
			[
				'label' => esc_html__( 'Settings', 'solace-extra' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'horizontal',
				'prefix_class' => 'solace-extra-checkout-',
				'options' => [
					'vertical' => esc_html__( 'One Column', 'solace-extra' ),
					'horizontal' => esc_html__( 'Two Columns', 'solace-extra' ),
				],
				'label_block' => false,
			]
		);
		...
		// 		],			
		// 		'selectors' => [
		// 			'{{WRAPPER}}.solace-extra-checkout-horizontal .solace-extra-checkout-order-review-table' => 'width: {{SIZE}}{{UNIT}};',
		// 			// '{{WRAPPER}}.solace-extra-checkout-horizontal #customer_details' => 'width: {{SIZE}}{{UNIT}};',
		// 			// '{{WRAPPER}}.solace-extra-checkout-horizontal .solace-extra-checkout-order-review-table' => 'width: calc(100% - {{SIZE}}{{UNIT}});',
		// 		],
		// 		'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .solace-extra-checkout-order-review-table-inner' => 'background-color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .solace-extra-checkout-order-review-table-inner' => 'border-color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .solace-extra-checkout-order-review-table-inner' => 'border-style: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .solace-extra-checkout-order-review-table-inner' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .solace-extra-checkout-order-review-table-inner' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .solace-extra-checkout-order-review-table-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.solace-extra-checkout-horizontal .woocommerce-checkout .col2-set' => 'margin-right: {{SIZE}}{{UNIT}};',
					'[data-elementor-device-mode="mobile"] {{WRAPPER}}.solace-extra-checkout-horizontal .woocommerce-checkout .col2-set' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.solace-extra-checkout-horizontal .col-1' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.solace-extra-checkout-horizontal .solace-extra-checkout-order-review-table-inner' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.solace-extra-checkout-vertical .col-1' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.solace-extra-checkout-vertical .col-2' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.solace-extra-checkout-vertical .solace-extra-checkout-order-review-table-inner' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Titles', 'solace-extra' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Labels', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#787878',
				'selectors' => [
					'.woocommerce form .form-row label, .woocommerce-page form .form-row label' => 'color: {{VALUE}} !important;',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Inputs', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'.woocommerce-page .woocommerce form .form-row input.input-text' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'.woocommerce-page .woocommerce form .form-row input.input-text' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__( 'Textarea Height', 'solace-extra' ),
				'size_units' => [ 'px', '%' ,'em'],
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Orders Table', 'solace-extra' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Table Heading', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Table Description', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Payment Method', 'solace-extra' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'  => esc_html__( 'Separator Color', 'solace-extra' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#E8E8E8',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Input', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Tooltips', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		// 	[
		// 		'type' => Controls_Manager::HEADING,
		// 		'label' => esc_html__( 'Order Received', 'solace-extra' ),
		// 		'separator' => 'before'
		// 	]
		// );
		...
		// 	[
		// 		'type' => Controls_Manager::HEADING,
		// 		'label' => esc_html__( 'Order Overview Typography', 'solace-extra' ),
		// 		'separator' => 'before'
		// 	]
		// );
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Coupon & Payment Method Button', 'solace-extra' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
	...
	public function woocommerce_checkout_before_customer_details() {
		echo '<div class="solace-extra-customer-details-wrapper">';
	}
	
	public function woocommerce_checkout_before_order_review_heading() {
        echo '<div class="solace-extra-checkout-order-review-table">';
        echo '<div class="solace-extra-checkout-order-review-table-inner">';
	}
	...
	public function woocommerce_checkout_order_review() {
		echo '</div>';
		echo '</div>';
		echo '<div class="solace-extra-checkout-order-review">';
	}
