...
class Post_Custom_Field extends Tag
{
	...
	{
		return 'solace-extra-post-custom-field';
	}

	public function get_title()
	{
		return esc_html__('Post Custom Field', 'solace-extra' );
	}
	...
	protected function register_controls()
	{
		$this->add_control(
			'key',
			[
				'label' => esc_html__('Key List', 'solace-extra' ),
		...
		$this->add_control(
			'custom_key',
			[
				'label' => esc_html__('Custom Key', 'solace-extra' ),
