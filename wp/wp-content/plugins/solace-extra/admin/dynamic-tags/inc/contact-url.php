...
class Solace_Extra_Contact_URL extends Tag
{

	public function get_name()
	{
		return 'solace-extra-contact-url';
	}

	public function get_title()
	{
		return esc_html__('Contact URL', 'solace-extra' );
	}
	...
	protected function register_controls()
	{
		$this->add_control(
			...
			[
				...
				'options' => [
					'' => '— ' . esc_html__('Select', 'solace-extra' ) . ' —',
					'email' => esc_html__('Email', 'solace-extra' ),
					'tel' => esc_html__('Tel', 'solace-extra' ),
					'sms' => esc_html__('SMS', 'solace-extra' ),
					'whatsapp' => esc_html__('WhatsApp', 'solace-extra' ),
					'skype' => esc_html__('Skype', 'solace-extra' ),
					'messenger' => esc_html__('Messenger', 'solace-extra' ),
					'viber' => esc_html__('Viber', 'solace-extra' ),
					'waze' => esc_html__('Waze', 'solace-extra' ),
					'google_calendar' => esc_html__('Google Calendar', 'solace-extra' ),
					'outlook_calendar' => esc_html__('Outlook Calendar', 'solace-extra' ),
					'yahoo_calendar' => esc_html__('Yahoo Calendar', 'solace-extra' ),
				],
			]
		);
		...
		$this->add_control(
			'mail_subject',
			[
				'label' => esc_html__('Subject', 'solace-extra' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'email',
		...
		$this->add_control(
			'username',
			[
				'label' => esc_html__('Username', 'solace-extra' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
		...
		$this->add_control(
			'viber_action',
			[
				'label' => esc_html__('Action', 'solace-extra' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'contact' => esc_html__('Contact', 'solace-extra' ),
					'add' => esc_html__('Add', 'solace-extra' ),
				],
				'default' => 'contact',
				'condition' => [
					'link_type' => 'viber',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'call' => esc_html__('Call', 'solace-extra' ),
					'chat' => esc_html__('Chat', 'solace-extra' ),
					'userinfo' => esc_html__('Show Profile', 'solace-extra' ),
					'add' => esc_html__('Add to Contacts', 'solace-extra' ),
					'voicemail' => esc_html__('Send Voice Mail', 'solace-extra' ),
				],
				'default' => 'call',
				'condition' => [
					'link_type' => 'skype',
		...
		$this->add_control(
			'waze_address',
			[
				'label' => esc_html__('Location', 'solace-extra' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'waze',
		...
		$this->add_control(
			'event_description',
			[
				'label' => esc_html__('Description', 'solace-extra' ),
				'type' => Controls_Manager::TEXTAREA,
				'condition' => [
					'link_type' => [
						'google_calendar',
		...
		$this->add_control(
			'event_start_date',
			[
				'label' => esc_html__('Start', 'solace-extra' ),
		...
		$this->add_control(
			'event_end_date',
			[
				'label' => esc_html__('End', 'solace-extra' ),
				'type' => Controls_Manager::DATE_TIME,
				'condition' => [
					'link_type' => [
						'google_calendar',
