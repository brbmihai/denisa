...
- **Text on dark:** `#FFFFFF`, Stone at 80% for secondary
...
| `body` | 0.9375rem | 1rem | 1rem | Inter | Default body |
| `body-sm` | 0.8125rem | 0.8125rem | 0.8125rem | Inter | Bios, meta |
| `label` | 0.6875rem | 0.6875rem | 0.75rem | Inter 600 | Tags, uppercase |
| `overline` | 0.6875rem | 0.6875rem | 0.75rem | Inter 600 | Section labels |
| `caption` | 0.75rem | 0.75rem | 0.75rem | Inter | Fine print |
| `nav` | 0.6875rem | 0.75rem | 0.8125rem | Inter 500 | Nav links |
| `button` | 0.8125rem | 0.875rem | 0.875rem | Inter 600 | Button labels |
...
| `stat-label` | 0.6875rem | 0.6875rem | 0.75rem | Inter | Stat captions |
| `form-title` | 1.5rem | 1.75rem | 2rem | Cormorant | Form headings |
| `form-label` | 0.8125rem | 0.8125rem | 0.875rem | Inter 600 | Field labels |
...
Apply responsive type with classes: `.text-display-hero`, `.text-heading-lg`, `.text-body`, `.text-nav`, `.text-form-label`, etc. See `denisa-dragomir-typography.css`.
...
| Stat box | `.ds-stat` | Responsive padding |
...
| Polaroid | `.ds-polaroid` | Rotated frame + Caveat caption |
| Timeline | `.ds-timeline` | Left border + orange dots |
| Alert | `.ds-alert--info/success/warning/error` | Left accent bar |
