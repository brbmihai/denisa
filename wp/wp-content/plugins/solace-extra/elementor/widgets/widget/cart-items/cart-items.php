...
class Solace_Extra_Cart_Items extends Widget_Base {

	public function __construct( $data = array(), $args = null ) {
		parent::__construct( $data, $args );
		wp_register_style( "solace-extra-cart", plugins_url( "assets/css/style.css", __FILE__ ), array(), SOLACE_EXTRA_VERSION );
	}	

	public function get_style_depends() {
		return array( "solace-extra-cart" );
	}	
	
	public function get_name() {
		return 'solace-extra-cart-items';
	}

	public function get_title() {
		return esc_html__( 'Cart', 'solace-extra' );
	}

	public function get_icon() {
		return 'eicon-woo-cart wlbi solace-extra';
	}

	public function get_categories() {
		return ['solace-extra-cart'];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_general',
			[
				'label' => esc_html__( 'General', 'solace-extra' ),
		...
		$this->add_control(
			'cart_layout',
			[
				'label' => esc_html__( 'Select Layout', 'solace-extra' ),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'vertical',
				'prefix_class' => 'solace-extra-cart-',
				'options' => [
					'vertical' => [
						'title' => esc_html__( 'Vertical', 'solace-extra' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'horizontal' => [
						'title' => esc_html__( 'Horizontal', 'solace-extra' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Cart Update', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Text', 'solace-extra' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__( 'Update Cart', 'solace-extra' ),
				'default' => esc_html__( 'Update Cart', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Totals', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Cart Totals', 'solace-extra' ),
				'default' => esc_html__( 'Cart Totals', 'solace-extra' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .solace-extra-cart-wrapper .cart-collaterals' => 'width: {{SIZE}}%;',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Checkout', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Proceed to Checkout', 'solace-extra' ),
				'default' => esc_html__( 'Proceed to Checkout', 'solace-extra' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'prefix_class' => 'solace-extra-checkout-flex-',
				'default' => 'end',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Shipping Update', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Update', 'solace-extra' ),
				'default' => esc_html__( 'Update', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Coupon', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Apply coupon', 'solace-extra' ),
				'default' => esc_html__( 'Apply coupon', 'solace-extra' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .solace-extra-cart-section-wrap .coupon-col-start' => 'width: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			'coupon_input_gutter',
			[
				'label' => esc_html__( 'Gutter', 'solace-extra' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Product Summary', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.solace-extra-cart-horizontal .woocommerce-cart-form' => 'width: {{SIZE}}{{UNIT}};',
					// '{{WRAPPER}}.solace-extra-cart-horizontal .cart-collaterals' => 'width: calc(100% - {{SIZE}}{{UNIT}});',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.solace-extra-cart-horizontal .woocommerce-cart-form' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.solace-extra-cart-vertical .woocommerce-cart-form' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					// '{{WRAPPER}} .solace-extra-cart-section-wrap .shop_table.cart' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .solace-extra-cart-section-table-wrap' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'[data-elementor-device-mode="mobile"] {{WRAPPER}}.solace-extra-cart-horizontal .cart-collaterals' => 'margin-top: {{SIZE}}{{UNIT}};',
					'[data-elementor-device-mode="mobile_extra"] {{WRAPPER}}.solace-extra-cart-horizontal .cart-collaterals' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'section_cart_styles',
			[
				'label' => esc_html__( 'Styles', 'solace-extra' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .solace-extra-cart-section-table-wrap' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} table td' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .solace-extra-cart-section' => 'background-color: {{VALUE}}',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .cart_totals, {{WRAPPER}} table.cart, {{WRAPPER}} .solace-extra-cart-section',
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Wrappers', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border Type', 'solace-extra' ),
				...
				'options' => [
					...
					'groove' => esc_html__( 'Groove', 'solace-extra' ),
				],
				'selectors' => [
					'{{WRAPPER}} .solace-extra-cart-section' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .cart_totals' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .solace-extra-cart-section-wrap table.shop_table td:not(:last-child)' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .solace-extra-cart-section-wrap table.shop_table th' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .solace-extra-cart-section-table-wrap' => 'border-style: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#E8E8E8',
				'selectors' => [
					'{{WRAPPER}} .solace-extra-cart-section' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .cart_totals' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .solace-extra-cart-section-wrap table.shop_table' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .solace-extra-cart-section-table-wrap' => 'border-color: {{VALUE}}'
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .solace-extra-cart-section' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .cart_totals' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .solace-extra-cart-section-wrap table.shop_table' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .solace-extra-cart-section-table-wrap' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
				'condition' => [
					'cart_wrappers_border_type!' => 'none',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .solace-extra-cart-section' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .cart_totals' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .solace-extra-cart-section-wrap table.shop_table' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .solace-extra-cart-section-table-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Table Cells', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .solace-extra-cart-section-table-wrap' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .solace-extra-cart-section' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Table Cell', 'solace-extra' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#FFFFFF',
				'selectors' => [
					'{{WRAPPER}} table.cart td' => 'background-color: {{VALUE}} !important;',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Product Image', 'solace-extra' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Box Size', 'solace-extra' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Forms', 'solace-extra' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_tab( 
			...
			[ 
				'label' => esc_html__( 'Focus', 'solace-extra' )
			] 
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Notice', 'solace-extra' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'notice_link_color',
			[
				'label' => esc_html__( 'Link Color', 'solace-extra' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#FFFFFF',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Link Hover Color', 'solace-extra' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#FFFFFF',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Success Color', 'solace-extra' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#FFFFFF',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Info Color', 'solace-extra' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#30B5FF',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Error Color', 'solace-extra' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#FF19FD',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Buttons', 'solace-extra' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Cart Totals', 'solace-extra' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'General Typography', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Headings', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .cart_totals th' => 'background-color: {{VALUE}} !important;'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Descriptions', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .cart_totals table.shop_table td' => 'background-color: {{VALUE}} !important;'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Shipping Calculator', 'solace-extra' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Change Address Padding', 'solace-extra' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'default' => [
					'top' => 6,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Checkout Button', 'solace-extra' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
	...
	public function woocommerce_before_cart() {
		echo '<div class="solace-extra-cart-wrapper">';
	}
	...
	public function woocommerce_before_cart_table() {
		echo '<div class="solace-extra-cart-section-wrap">';
		echo '<div class="solace-extra-cart-section-table-wrap">';
	}
	...
	public function render_woocommerce_cart_coupon_form() {
		...
		?>
			<div class="coupon solace-extra-cart-section shop_table">
				<div class="form-row coupon-col">
					...
					<div class="coupon-col-end">
						<button <?php $this->print_render_attribute_string( 'button_coupon' ); ?> value="<?php esc_attr_e( 'Apply coupon', 'solace-extra' ); ?>"><?php esc_attr_e( 'Apply coupon', 'solace-extra' ); ?></button>
					</div>
	...
	public function filter_gettext( $translation, $text, $domain ) {
		if ( 'woocommerce' !== $domain && 'solace-extra' !== $domain ) {
			return $translation;
		}
