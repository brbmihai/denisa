...
class Solace_Extra_Purchase_Summary extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'solace-extra-woocommerce-purchase-summary';
	}

	public function get_title() {
		return esc_html__( 'Purchase Summary', 'solace-extra' );
	}

	public function get_icon() {
		return 'eicon-purchase-summary solace-extra';
	}

	public function get_keywords() {
		return [ 'woocommerce', 'summary', 'thank you', 'confirmation', 'purchase', 'solace', 'extra' ];
	}
	...
	public function get_style_depends(): array {
		return [ 'solace-extra-purchase-summary' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Confirmation Message', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Message', 'solace-extra' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'default' => esc_html__( 'Thank You. Your order has been received.', 'solace-extra' ),
				'label_block' => true,
				'condition' => [
					'confirmation_message_active!' => '',
				],
		...
		$this->start_controls_section(
			'payment_details',
			[
				'label' => esc_html__( 'Payment Details', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Number', 'solace-extra' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				...
				'default' => esc_html__( 'Order Number:', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Date:', 'solace-extra' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				...
				'default' => esc_html__( 'Order Date:', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Email', 'solace-extra' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				...
				'default' => esc_html__( 'Order Email:', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Total', 'solace-extra' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				...
				'default' => esc_html__( 'Order Total:', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Payment', 'solace-extra' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				...
				'default' => esc_html__( 'Payment Method:', 'solace-extra' ),
			]
		);
		...
		$this->start_controls_section(
			'bank_details',
			[
				'label' => esc_html__( 'Bank Details', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Our Bank Details', 'solace-extra' ),
			]
		);
		...
		$this->start_controls_section(
			'downloads',
			[
				'label' => esc_html__( 'Downloads', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Downloads', 'solace-extra' ),
			]
		);
		...
		$this->start_controls_section(
			'order_summary',
			[
				'label' => esc_html__( 'Purchase Summary', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Order Details', 'solace-extra' ),
			]
		);
		...
		$this->start_controls_section(
			'billing_details',
			[
				'label' => esc_html__( 'Billing Details', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Billing Details', 'solace-extra' ),
			]
		);
		...
		$this->start_controls_section(
			'shipping_details',
			[
				'label' => esc_html__( 'Shipping Address', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Shipping Details', 'solace-extra' ),
			]
		);
		...
		$this->start_controls_section(
			'preview_order',
			[
				'label' => esc_html__( 'Preview Settings', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			'preview_order_type',
			[
				'label' => esc_html__( 'Preview order with', 'solace-extra' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Order ID', 'solace-extra' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
				...
				'description' => esc_html__( 'Note: To find an order ID, go to the WP dashboard: WooCommerce > Orders', 'solace-extra' ),
			]
		);
		...
		$this->start_controls_section(
			'sections_tabs_style',
			[
				'label' => esc_html__( 'Sections', 'solace-extra' ),
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'General Text', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Items', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Dividers', 'solace-extra' ),
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Account Title', 'solace-extra' ),
			]
		);
		...
		$this->start_controls_section(
			'order_details_title',
			[
				'label' => esc_html__( 'Order Details', 'solace-extra' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Rows Gap', 'solace-extra' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Titles &amp; Totals', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Variations', 'solace-extra' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Product Link', 'solace-extra' ),
			]
		);

		$this->start_controls_tabs( 'order_details_product_links_colors' );

		$this->start_controls_tab( 'order_details_product_links_normal_colors', [ 'label' => esc_html__( 'Normal', 'solace-extra' ) ] );
		...
		$this->start_controls_tab( 'order_details_product_links_hover_colors', [ 'label' => esc_html__( 'Hover', 'solace-extra' ) ] );
		...
		// $this->start_controls_tab( 'order_details_button_styles_normal', [ 'label' => esc_html__( 'Normal', 'solace-extra' ) ] );
		...
		// $this->start_controls_tab( 'order_details_button_styles_hover', [ 'label' => esc_html__( 'Hover', 'solace-extra' ) ] );
		...
		// 	[
		// 		'label' => esc_html__( 'Transition Duration', 'solace-extra' ) . ' (ms)',
		// 		'type' => Controls_Manager::SLIDER,
		// 		'selectors' => [
	...
	public function no_order_notice() {
		...
		<div class="woocommerce-error" role="alert">
			<?php echo esc_html__( 'You need at least one WooCommerce order to preview the order here.', 'solace-extra' ); ?>
		</div>
		<?php
	}
